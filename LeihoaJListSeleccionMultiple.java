...
public class LeihoaJListSeleccionMultiple extends JFrame implements ActionListener{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					LeihoaJListSeleccionMultiple frame = new LeihoaJListSeleccionMultiple();
	...
	// JFrame
	public LeihoaJListSeleccionMultiple() {
		...
		btnGarbitu.setVerticalAlignment(SwingConstants.BOTTOM);
	...
	public void actionPerformed(ActionEvent ae) {
		...
		else if (source == this.btnGarbitu){
			dlm.clear();
			dlm.addElement("1AS3");
			dlm.addElement("2AS3");
			dlm.addElement("1DW3");
			dlm.addElement("2DW3");
			lstGruposCopia.removeAll();
		}
	}
